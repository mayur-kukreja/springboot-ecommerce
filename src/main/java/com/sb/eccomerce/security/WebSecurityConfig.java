...
import com.sb.eccomerce.security.jwt.AuthEntryPointJwt;
import com.sb.eccomerce.security.jwt.AuthTokenFilter;
import com.sb.eccomerce.security.services.UserDetailsServiceImpl;
...
//            Set<Role> adminRoles = Set.of(userRole, (Role) sellerRoles, adminRole);
